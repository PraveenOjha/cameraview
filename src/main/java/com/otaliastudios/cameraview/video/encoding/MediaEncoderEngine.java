 ...
 *  * Last modified 19/09/25, 10:05 pm
...
public class MediaEncoderEngine {
    ...
    /**
     * Creates a new engine for the given file descriptor, with the given encoders and max limits,
     * and listener to receive events.
     *
     ...
     * @param listener a listener
     */
    public MediaEncoderEngine(@NonNull FileDescriptor fd,
                              @NonNull VideoMediaEncoder videoEncoder,
                              @Nullable AudioMediaEncoder audioEncoder,
                              final int maxDuration,
                              final long maxSize,
        ...
        try {
            if (Build.VERSION.SDK_INT < 26) {
                throw new RuntimeException("Recording to FileDescriptor requires API 26+");
            }
