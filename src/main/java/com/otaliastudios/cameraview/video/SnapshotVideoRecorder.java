 ...
 *  * Last modified 20/09/25, 2:48 am
    ...
    public void onRendererFrame(@NonNull SurfaceTexture surfaceTexture, int rotation,
        ...
        if (mCurrentState == STATE_NOT_RECORDING && mDesiredState == STATE_RECORDING) {
            ...
            boolean hasAudio = audioChannels > 0
                    && mResult.audioInput != CameraView.AudioInput.NONE
                    && mResult.getAudioVolume() > 0;
            ...
            if (hasAudio) {
                ...
                // propagate audio input selection
                if (mResult.audioInput != null) {
                    audioConfig.setAudioInput(mResult.audioInput);
                } else {
                    audioConfig.setAudioInput(CameraView.AudioInput.DEFAULT);
                }
                // propagate volume preference
                audioConfig.setVolumePercent(mResult.getAudioVolume());
            ...
            synchronized (mEncoderEngineLock) {
                if (mResult.file != null) {
                ...
                } else if (mResult.fileDescriptor != null) {
                    ...
                    throw new IllegalStateException("Missing output: file or fileDescriptor");
                }
                mEncoderEngine.notify(TextureMediaEncoder.FILTER_EVENT, mCurrentFilter);
