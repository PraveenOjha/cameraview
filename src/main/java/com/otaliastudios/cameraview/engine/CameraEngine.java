 ...
 *  * Last modified 20/09/25, 2:12 am
...
public abstract class CameraEngine implements
    ...
    public abstract void takeVideoSnapshot(@NonNull VideoResult.Stub stub, @NonNull FileDescriptor fileDescriptor);
    public abstract void stopVideo();

    //endregion

    //region Audio input routing API

    /**
     * Sets desired audio input routing for upcoming recordings.
     */
    public abstract void setAudioInput(@NonNull com.otaliastudios.cameraview.CameraView.AudioInput input);

    /**
     * Returns desired audio input routing for recordings.
     */
    @NonNull
    public abstract com.otaliastudios.cameraview.CameraView.AudioInput getAudioInput();

    /**
     * Sets desired audio input volume (0..100) for upcoming recordings.
     */
    public abstract void setAudioVolume(int percent);

    /**
     * Returns desired audio input volume (0..100) for recordings.
     */
