...
public class VideoResult {
    ...
    public static class Stub {
        ...
        public Audio audio;
        public CameraView.AudioInput audioInput;
        // Volume percent for audio input (0..100). 100 = original gain.
        ...
        // Added: convenient accessors for audio input routing
        ...
        public void setAudioVolume(int percent) {
            ...
            this.audioVolume = percent;
        }
        @NonNull
        public CameraView.AudioInput getAudioInput() {
            return audioInput != null ? audioInput : CameraView.AudioInput.DEFAULT;
        }
    ...
    private final CameraView.AudioInput audioInput;
    ...
    VideoResult(@NonNull Stub builder) {
        ...
        audio = builder.audio;
        audioInput = builder.audioInput;
        audioVolume = builder.audioVolume;
    ...
    /**
     * Returns the audio input routing used for this video.
     */
    @NonNull
    public CameraView.AudioInput getAudioInput() {
        return audioInput;
    ...
    /**
     * Returns the configured audio input volume for this video (0..100).
     */
